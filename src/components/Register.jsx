        ...
        <div className="h-[calc(100vh-120px)] flex justify-center items-center ">
            <div className="w-full max-w-sm mx-auto bg-white shadow-md px-8 pt-6 pb-8 mb-4">
                ...
                <form action="">
                    ...
                    <div>
                        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold rounded px-8 py-2 focus:outline-none">Sign Up</button>
                    </div>
                </form>
                <p className="align-baseline text-sm font-medium mt-4 mb-2">Already have an account? <Link to="/login" className="text-blue-500 hover:text-blue-700">Login</Link></p>
